...
// reference code
// 		template <class T, class S> struct has_element_x
// 		{
// 			template <class U>
// 			struct test
// 			{
// 				static YES &conversion(S T::*);
// 				static NO &conversion(...);
// 				static bool const value = sizeof conversion(&U::x) == sizeof(YES);
// 			};
// 			struct explicit_member { S x; };
// 			struct help : public explicit_member, public T{};
// 			template <typename U>
// 			static NO has(U&, wrapper<S explicit_member::*, &U::x>* = 0);
// 			static YES has(...);
