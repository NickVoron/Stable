...
float3 lightColor = float3(1,0.8,0.6);
...
{ 
	...
	Out.color.rgb = light + 0.1f;//(In.Color.r + nDotL*shadow*parallax.z)*getSunColor()*0.8f + dot(shpAmb, SHAmbHeight)*In.Color.g*getAmbientColor()*0.4f;
